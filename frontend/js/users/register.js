...
function userExists(username) {
    fetch('https://jsonplaceholder.typicode.com/users')  //TODO: change endpoint
        .then((res) => {
            return res.json();
        })
        .then((data) => {
            ...
            data.forEach(user => {
                if(user.username === username) {
                    document.getElementById('username-error').innerHTML += "Потребителят " + username + " вече съществува.";
